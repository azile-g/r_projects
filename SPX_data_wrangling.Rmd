---
title: "DSA212: Assignment 1"
output: html_notebook
---

Name: Elizabeth Cheng Wei
Student ID: 01394073
Section: G2 Wed
...
3)
DF has 20 columns and 143, 760 rows. 
...
5)
DF now has 4 columns and 143, 760 rows.

Aside: Hi prof, I know the question says to choose column X1, but it's called X in the dataframe I retrieved, so I'm using X for 2). 
...
5)
SPX has 4 columns and 5, 111 rows. 
...
3)
SPX now has 8 columns and 5, 111 rows. 
...
PDF export attached to assignment submission seperately. 
